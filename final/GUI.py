...
def run_scan():
    ...
    plt.close(fig)
    from Scanner import threatCountGraph
    threat_path = "threats_bar.png"
    threatCountGraph(results, out_path=threat_path)
    generate_pdf(results, pdf_path=pdf_path, severity_chart_path=chart_path, threat_chart_path=threat_path)
